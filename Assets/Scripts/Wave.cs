...
// Questo script genera le waves di nemici, definendo: il numero di nemici, la loro velocità e l'intervallo con il quale vengono attivati
// in più definisce la modalità di shooting e il movimento all'interno del percorso
[System.Serializable]
...
public class Wave : MonoBehaviour {
    ...
    void DrawPath(Transform[] path) //disegno il percorso nell'editor
    {
    ...
    Vector3[] CreatePoints(Vector3[] path)  //tramite il metodo dell'interpolazione calcola il percorso lungo i punti del percorso
    {
